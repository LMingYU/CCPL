...
class CNN(MetaModule):
    def __init__(self, n_out):
        ...
        self.fc1 = nn.Linear(32 * 7 * 7, 64 * 2)
...
class CNNfm(MetaModule):
    def __init__(self, n_out):
        super(CNNfm, self).__init__()

        self.conv = torch.nn.Sequential(MetaConv2d(3, 16, 3, padding=1),
                                        BatchNorm2d(16),
